...
var galeryListRef = document.querySelector(".js-gallery");
var modelWindowRef = document.querySelector(".js-lightbox");
var menuBtnRef = document.querySelector(".lightbox__button");
var imageRef = document.querySelector(".lightbox__image");
var overlayRef = document.querySelector(".lightbox__overlay");
var number = 0;
var imagesGallery = createGalleryMarkup(galleryItems);
...
function createGalleryMarkup(imagesList) {
  return imagesList.map(function (_ref) {
...
function getImageIndex(imageLink) {
  return galleryItems.indexOf(galleryItems.find(function (imageObj) {
    return imageObj.preview === imageLink;
  }));
}
function onClickImage(event) {
  event.preventDefault();
  if (event.target.nodeName === "IMG") {
    setImageAttr(event.target.attributes["data-source"].value, event.target.alt);
